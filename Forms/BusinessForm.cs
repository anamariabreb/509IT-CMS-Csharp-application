    ...
    public partial class BusinessForm : Form
    {
        ...
        public BusinessForm()
        {
            ...
            if (mysqlConn.connOpen() == true)
            {
                ...
                dataGridView1.Columns[4].HeaderText = "Business Tel";
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                tbBusinessTel.Text = dataGridView1.SelectedRows[0].Cells[4].Value.ToString();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            if (mysqlConn.connOpen() == true)
            {
                dataGridView1.DataSource = mysqlConn.qry("SELECT * FROM `BusinessContact` where contactEmail='" + tbEmail.Text + "'").Tables[0];
            }
            mysqlConn.connClose();
        }
